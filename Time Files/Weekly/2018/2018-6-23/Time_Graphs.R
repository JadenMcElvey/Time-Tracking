...
MinorxTime <- MinorxTime + labs(subtitle = "Assessing Utility and Necesitty")
...
SpecxTime <- SpecxTime + labs(subtitle = "Assessing Utility and Necesitty")
...
print(SpecxTime)
# Save plot
ggsave("MajorxTime.png", MajorxTime, width=15, height=5)
ggsave("MinorxTime.png", MinorxTime, width=15, height=5)
ggsave("SpecxTime.png", SpecxTime, width=15, height=5)